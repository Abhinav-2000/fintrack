...
export default function Signup() {
  ...
  return (
    <div className="min-h-screen bg-gray-950 flex items-center justify-center p-6 origin-top">
      <div className="w-full max-w-md origin-center 
scale-[0.85] sm:scale-[0.9] lg:scale-100">
        ...
        <p className="text-gray-400 mb-8 text-center">Start tracking your finances for free</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <input type="text" required value={form.name}
                ...
                className="w-full bg-gray-800 border border-gray-700 rounded-xl px-4 py-2.5 text-white placeholder-gray-500 focus:outline-none focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500 transition-colors"
            ...
            <div>
              ...
              <div className="relative">
                <input type={showPass ? 'text' : 'password'} required value={form.password}
                  ...
                  className="w-full bg-gray-800 border border-gray-700 rounded-xl px-4 py-2.5 pr-12 text-white placeholder-gray-500 focus:outline-none focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500 transition-colors"
